...
import { createOrder, deleteOrder, getAllOrder, getOrderDetails, getSales, updateOrderDetails, userOrders } from "../controllers/orderControllers.js";
...
router
  ...
  .get(isAuthenticatedUser, authorizeRole("admin"), getSales);
